...
const ShoppingCard = ({ image, name, price, description, rating, reviews }) => {
  ...
  return (
    <div className='relative flex flex-col w-[296px] h-[364px] rounded-[10px] border border-solid border-black px-4 py-6 cursor-pointer mb-[45px] '>
      ...
      <p className='font-manrope text-black/70 text-[12px] font-[700] tracking-[1px] leading-[14px] mt-[-10px]'>{description}</p>
      <div className='flex flex-row items-center mb-[10px]'>
        {ratingStars}
        <p className='font-manrope text-[12px] text-black/70 tracking-[1.2px] leading-[17px]'>({reviews})</p>
      </div>
      <div className='flex w-[132px] h-[45px] bg-black rounded-[14px] items-center justify-center border-[#808080] border-solid border-b-[6px] border-l-[6px] ' onClick={handleClick} >
